				...
				<div class="row" ng-controller="RecipeList as recipeList">
					<div class="col-sm-6 col-md-4 col-lg-3 recipe" ng-repeat="recipe in recipeList.posts">
						<article class="snippet" >
		                    <a target="_self" href="{{recipe.link}}" title="{{recipe.title}}" class="snippet-image" oonclick="location.reload()">
							...
							<div class="info">
								<h5 class="title"><a target="_self" href="{{recipe.link}}" ng-bind-html="recipe.title" oonclick="location.reload()"></a></h5>
								<p class="hidden-xs hidden-sm" ng-bind-html="recipe.excerpt | words:24"></p>
							</div>
							<a class="btn btn-primary" target="_self" href="{{recipe.link}}" oonclick="location.reload()"><?php _e('View', 'nuzest-custom') ?></a>
						</article>
					</div>
