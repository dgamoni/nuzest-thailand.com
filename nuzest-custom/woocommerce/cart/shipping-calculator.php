...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<p class="shipping-calculator-p"><a href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></p>

	<section class="shipping-calculator-form" style="display:none;">

		<!-- show region toggle -->
		<p class="region-select">Can’t see your country in the list? Perhaps&nbsp;you&nbsp;need to <a href="#">switch regions</a>.</p>
