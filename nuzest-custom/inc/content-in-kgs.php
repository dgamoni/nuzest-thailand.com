<div class="container" id="in-slide">
	...
	<div class="in-image" style="background-image: url('<?php bloginfo('template_directory'); ?>/images/ing-panels/ing-kgs.jpg');"></div>

    <?php
		$prodPage = get_page_by_path( 'kids-good-stuff' );
	...
	<div class="row in-content">
		...
		?>
			...
			<div class="in-group kgs-<?php echo $catNum; ?>">
                        ...
                        <?php else : ?>
                            <li>
                                ...
                                <?php if( get_sub_field( 'nrv' ) ) : ?>
                                	<span data-toggle="tooltip" data-placement="top" title="<?php echo get_sub_field( 'nrv' ) . '% RDI'; ?>"><?php the_sub_field( 'amount' ); ?></span>
                                <?php else : ?>
